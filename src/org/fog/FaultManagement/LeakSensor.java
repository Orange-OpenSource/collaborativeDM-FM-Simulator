...
public class LeakSensor extends MySensor {

    private boolean state;
    private HighVariance hv;
    public LeakSensor(String name, int userId, String appId, int gatewayDeviceId, double latency, GeoLocation geoLocation, Distribution transmitDistribution, int cpuLength, int nwLength, String tupleType, String destModuleName) {
    ...
    public LeakSensor(String name, String tupleType, int userId, String appId, Distribution transmitDistribution) {
        ...
        switch(ev.getTag()){
            ...
            case FogEvents.EMIT_TUPLE:
                ...
                {   transmit();
                    ...
                    send(getId(),  43200000, FogEvents.EMIT_TUPLE); //delay is the frequency of readings
                }
                break;
