...
public class SmokeSensor extends MySensor {

    private boolean state;
    private HighVariance hv;
    public SmokeSensor(String name, int userId, String appId, int gatewayDeviceId, double latency, GeoLocation geoLocation, Distribution transmitDistribution, int cpuLength, int nwLength, String tupleType, String destModuleName) {
    ...
    public SmokeSensor(String name, String tupleType, int userId, String appId, Distribution transmitDistribution) {
        ...
        switch(ev.getTag()){
            ...
            case FogEvents.EMIT_TUPLE:
                ...
                {   transmit();
                    ...
                    send(getId(),  28800000, FogEvents.EMIT_TUPLE); //delay is the frequency of readings
                }
                break;
