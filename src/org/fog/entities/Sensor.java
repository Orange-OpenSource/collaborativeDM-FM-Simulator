...
public class Sensor extends SimEntity{
	...
	public void startEntity() {
		...
		send(getId(), getTransmitDistribution().getNextValue() + transmissionStartDelay, FogEvents.EMIT_TUPLE, getTransmitDistribution().getNextValue());
	}
	...
	public void processEvent(SimEvent ev)  {
		...
		case FogEvents.EMIT_TUPLE:
			transmit();
			//System.out.println( "Sending tuple with tupleId = "+getTransmitDistribution().getNextValue());
