...
public class Actuator extends SimEntity{
	...
	public void processEvent(SimEvent ev) {
		...
		case FogEvents.TUPLE_ARRIVAL:
			...
			break;
			case FogEvents.FAILURE:
				Logger.debug(getName(),"Failure");
				break;
		}		
	}
	...
	public void processTupleArrival(SimEvent ev) {
		...
		Logger.debug(getName(), " Received tuple "+tuple.getCloudletId()+" on "+tuple.getDestModuleName() + " data " +tuple.getData());
		//System.out.println(getName()+" Received tuple "+tuple.getCloudletId()+" on "+tuple.getSrcModuleName());
