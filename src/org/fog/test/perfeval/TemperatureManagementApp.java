 ...
 *
 */
public class TemperatureManagementApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String appId = "TemperatureManagement"; // identifier of the application
          ...
          /* FaultInjector fault=new FaultInjector("HighVariance",600500, sensors.get(0).getId(), FailureType.HIGHVARIANCE);
            ...
            recoveryActions.add(recovery);*/
             ...
             moduleMapping.addModuleToDevice("temperature_management", "smartThingsHub");  // fixing 1 instance of the Motion Detector module to each Smart Camera
    ...
    private static void createFogDevices(int userId, String appId) {
        ...
        fogDevices.add(hub);
        Sensor sensor = new MySensor("TemperatureSensor", "TEMPERATURE", userId, appId, new DeterministicDistribution(5));
        sensors.add(sensor);
        Actuator actuator = new MyActuator("AC", userId, appId, "AC_CONTROL");
    ...
    private static Application createApplication(String appId, int userId){
         ...
         */
         application.addAppModule("temperature_management", 10);

        /*
         * Connecting the application modules (vertices) in the application model (directed graph) with edges
         */
        application.addAppEdge("TEMPERATURE", "temperature_management", 1000, 2000, "TEMPERATURE", Tuple.UP, AppEdge.SENSOR); // adding edge from CAMERA (sensor) to Motion Detector module carrying tuples of type CAMERA
        application.addAppEdge("temperature_management", "AC_CONTROL", 100, 100, "AC_PARAMS", Tuple.DOWN, AppEdge.ACTUATOR); // adding edge from Object Tracker to PTZ CONTROL (actuator) carrying tuples of type PTZ_PARAMS

        /*
         * Defining the input-output relationships (represented by selectivity) of the application modules.
         */
        application.addTupleMapping("temperature_management", "TEMPERATURE", "AC_PARAMS", new FractionalSelectivity(1.0)); // 1.0 tuples of type MOTION_VIDEO_STREAM are emitted by Motion Detector module per incoming tuple of type CAMERA

        /*
         * Defining application loops (maybe incomplete loops) to monitor the latency of.
         * Here, we add two loops for monitoring : Motion Detector -> Object Detector -> Object Tracker and Object Tracker -> PTZ Control
         */
      final AppLoop loop1 = new AppLoop(new ArrayList<String>(){{add("TEMPERATURE");add("temperature_management"); add("AC_CONTROL");}});
